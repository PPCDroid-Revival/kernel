 ...
 */
static int __devinit spi_ppc4xx_of_probe(struct platform_device *op)
{
	struct ppc4xx_spi *hw;
	struct spi_master *master;
...
static int __devexit spi_ppc4xx_of_remove(struct platform_device *op)
{
...
static struct platform_driver spi_ppc4xx_of_driver = {
	...
	.remove = __devexit_p(spi_ppc4xx_of_remove),
	.driver = {
		.name = DRIVER_NAME,
		.owner = THIS_MODULE,
